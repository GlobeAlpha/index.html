   ...
   $.getJSON(API, function (data)
   {
         $("#GetWeather").click(function ()
         {
            ...
            // L.mapbox.config.FORCE_HTTPS = true;
                  L.tileLayer('https://api.mapbox.com/styles/mbajda/ckj1thqqu0r7t19p30ui4b1vn.html?fresh=true&title=view&access_token=pk.eyJ1IjoibWJhamRhIiwiYSI6ImNrajF0ZTA2czJ5ajEydm1tcnZjYnhuczQifQ.wt5bVKziFjaIRXlOREJH7Q', {
